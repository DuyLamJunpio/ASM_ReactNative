...
const EditContent = (props) => {
    ...
    const [content, setContent] = useState(props.dataBlog.content);
    const [image, setiimg_base64] = useState(props.dataBlog.image);
    ...
    const editData = () => {
        let like = props.dataBlog.like;
        let commentId = props.dataBlog.commentId;
        ...
        //2. Dùng fetch:
        let api_url = 'http://44.168.0.102:3000/blogs/' + props.dataBlog.id
